    ...
    def top_comment_strip(self):
        ...
        while 1:
            ...
            for x in response["items"]:
                ...
                try:
                    self.comment_channel_id_pop.append(
                ...
                try:
                    self.comment_channel_name_pop.append(
                ...
                if x['snippet']['totalReplyCount'] > 0:
                    self.reply_strip(x['snippet']['topLevelComment']['id'],
        ...
        output_dict = {
            ...
            "commentSentiment": self.comment_sentiment_pop,
            ...
            for item in response["items"]:
                if not item['statistics']['hiddenSubscriberCount']:
                    subscriber_list.append(
                        {'channelSubCount': int(item['statistics']['subscriberCount']), "commentChannelId": item['id']})
                else:
